    ...
    public static class RAF
    {
        ...
        public static bool CanAoEInstance
        {
            get
            {
                ...
                {
                    if (u.HealthPercent < 15) continue;                                         // If the mobs health is below 25% don't include it
        ...
        public static WoWUnit RAFTank
        {
            get
            {
                ...
                {
                    string partyRole = Lua.GetReturnVal<string>("return UnitGroupRolesAssigned(\"party" + i + "\")", 0);
