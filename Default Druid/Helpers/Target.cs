...
namespace Hera.Helpers
{
    public static class Target
    {
        ...
        /// <summary>
        /// TRUE if the current target is more than 6 levels lower than you
        /// </summary>
        ...
        public static bool IsFleeing { get { if (!Me.GotTarget) return false; if (CT.Fleeing) return true;  return false; }  }
        ...
        public static bool IsCasting { get { if (!Me.GotTarget) return false; return CT.IsCasting; } }
        ...
        /// </summary>
        public static bool IsCaster { get { if (Me.GotTarget && CT.ManaPercent > 1) return true; return false; } }
        ...
        public static bool CanGenerateNavPath
        {
            ...
            {
                if (!Me.GotTarget) return false;
                return Navigator.CanNavigateFully(Me.Location, CT.Location, 60);
