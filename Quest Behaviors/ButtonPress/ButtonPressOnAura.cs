...
namespace Honorbuddy.Quest_Behaviors.ButtonPress.ButtonPressOnAura
{
    ...
    public class ButtonPressOnAura : CustomForcedBehavior
    {
        ...
        private IEnumerable<WoWAura> _emptyAuras = new List<WoWAura>();
        private static LocalPlayer Me { get { return (StyxWoW.Me); } }
        private readonly Dictionary<int, int> _selfAuraToButtonMap = new Dictionary<int, int>();
        private readonly Dictionary<int, int> _targetAuraToButtonMap = new Dictionary<int, int>();
