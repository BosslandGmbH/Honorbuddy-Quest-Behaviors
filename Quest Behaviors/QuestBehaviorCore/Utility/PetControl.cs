...
namespace Honorbuddy.QuestBehaviorCore
{
    public class PetControl
    {
        ...
        private static WoWPetSpell s_petActionAttack;
        ...
        private static WoWPetSpell s_petActionFollow;
        ...
        {
            if (Me.GotAlivePet)
            { SetStance_Internal(s_petStanceAssist ?? (s_petStanceAssist = FindPetActionByName("Assist"))); }
        }
        private static WoWPetSpell s_petStanceAssist;


        public static void SetStance_Defensive()
        {
            if (Me.GotAlivePet)
            { SetStance_Internal(s_petStanceDefensive ?? (s_petStanceDefensive = FindPetActionByName("Defensive"))); }
        }
        private static WoWPetSpell s_petStanceDefensive;


        public static void SetStance_Passive()
        {
            if (Me.GotAlivePet)
            { SetStance_Internal(s_petStancePassive ?? (s_petStancePassive = FindPetActionByName("Passive"))); }
        }
        private static WoWPetSpell s_petStancePassive;
