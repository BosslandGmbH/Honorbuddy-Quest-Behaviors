...
namespace Honorbuddy.Quest_Behaviors.GetOutOfGroundEffectAndAuras
{
    ...
    public class GetOutOfGroundEffectAndAuras : CustomForcedBehavior
    {
        ...
        private readonly TimeSpan _delay_GossipDialogThrottle = TimeSpan.FromMilliseconds(1000);
        ...
        private IEnumerable<WoWUnit> _meAsGroup = new List<WoWUnit>() { StyxWoW.Me };
                    ...
                    new Switch<BehaviorStateType>(context => _behaviorState,
                        ...
                        new SwitchArgument<BehaviorStateType>(BehaviorStateType.InteractingToStart,
                            new PrioritySelector(
                                ...
                                new Decorator(escortedUnitsContext => IsInCombat(_meAsGroup),
                                    new Action(escortedUnitsContext =>
                                    {
                    ...
                    new PrioritySelector(
                        ...
                        new Decorator(gossipUnitContext => (GossipFrame.Instance == null) || !GossipFrame.Instance.IsVisible,
                            new Sequence(
                                ...
                                new WaitContinue(_lagDuration, ret => GossipFrame.Instance.IsVisible, new ActionAlwaysSucceed()),
                                new WaitContinue(_delay_GossipDialogThrottle, ret => GossipFrame.Instance.IsVisible, new ActionAlwaysSucceed()),
