    ...
    public class SealingTheWay : CustomForcedBehavior
    {
        ...
        private Composite Part1()
        {
            ...
            new PrioritySelector(
                ...
                new Decorator(r => Geomancer(_spots[0]) != null && Geomancer(_spots[0]).Distance > 10,
                    new Action(r => Navigator.MoveTo(Geomancer(_spots[0]).Location))),
                new Decorator(r => (Me.CurrentTarget == null || (Me.CurrentTarget != null && Me.CurrentTarget.IsFriendly)) && Bad(_spots[0]) != null,
                    new Action(r => Bad(_spots[0]).Target())),
                new Decorator(r => (Me.CurrentTarget == null || (Me.CurrentTarget != null && Me.CurrentTarget.IsFriendly)) && (Geomancer(_spots[0]).CurrentTarget != null),
                    new Action(r => Geomancer(_spots[0]).CurrentTarget.Target())),
                new Decorator(r => !Me.Combat && Bad(_spots[0]) != null, DoPull),
                new Decorator(r => Me.Combat && Bad(_spots[0]) != null && !Me.CurrentTarget.IsFriendly, DoDps),
                    new Decorator(r => Bad(_spots[0]) == null,
        ...
        private Composite Part2()
        {
            ...
            new PrioritySelector(
                new Decorator(r => Me.CurrentTarget != null && Me.CurrentTarget.IsDead,
                    new Action(r => Me.ClearTarget())),
                new Decorator(r => Geomancer(_spots[1]) != null && Geomancer(_spots[1]).Distance > 10,
                    new Action(r => Navigator.MoveTo(Geomancer(_spots[1]).Location))),
                new Decorator(r => (Me.CurrentTarget == null || (Me.CurrentTarget != null && Me.CurrentTarget.IsFriendly)) && Bad(_spots[1]) != null,
                    new Action(r => Bad(_spots[1]).Target())),
                new Decorator(r => (Me.CurrentTarget == null || (Me.CurrentTarget != null && Me.CurrentTarget.IsFriendly)) && (Geomancer(_spots[1]).CurrentTarget != null),
                    new Action(r => Geomancer(_spots[1]).CurrentTarget.Target())),
                new Decorator(r => !Me.Combat && Bad(_spots[1]) != null, DoPull),
                new Decorator(r => Me.Combat && Bad(_spots[1]) != null && !Me.CurrentTarget.IsFriendly, DoDps),
                    new Decorator(r => Bad(_spots[1]) == null,
        ...
        private Composite Part3()
        {
            ...
            new PrioritySelector(
                new Decorator(r => Me.CurrentTarget != null && Me.CurrentTarget.IsDead,
                    new Action(r => Me.ClearTarget())),
                new Decorator(r => Geomancer(_spots[2]) != null && Geomancer(_spots[2]).Distance > 10,
                    new Action(r => Navigator.MoveTo(Geomancer(_spots[2]).Location))),
                new Decorator(r => (Me.CurrentTarget == null || (Me.CurrentTarget != null && Me.CurrentTarget.IsFriendly)) && Bad(_spots[2]) != null,
                    new Action(r => Bad(_spots[2]).Target())),
                new Decorator(r => (Me.CurrentTarget == null || (Me.CurrentTarget != null && Me.CurrentTarget.IsFriendly)) && (Geomancer(_spots[2]).CurrentTarget != null),
                    new Action(r => Geomancer(_spots[2]).CurrentTarget.Target())),
                new Decorator(r => !Me.Combat && Bad(_spots[2]) != null, DoPull),
                new Decorator(r => Me.Combat && Bad(_spots[2]) != null && !Me.CurrentTarget.IsFriendly, DoDps),
                    new Decorator(r => Bad(_spots[2]) == null,
        ...
        private Composite Part4()
        {
            ...
            new PrioritySelector(
                new Decorator(r => Me.CurrentTarget != null && Me.CurrentTarget.IsDead,
                    new Action(r => Me.ClearTarget())),
                new Decorator(r => Geomancer(_spots[3]) != null && Geomancer(_spots[3]).Distance > 10,
                    new Action(r => Navigator.MoveTo(Geomancer(_spots[3]).Location))),
                new Decorator(r => (Me.CurrentTarget == null || (Me.CurrentTarget != null && Me.CurrentTarget.IsFriendly)) && Bad(_spots[3]) != null,
                    new Action(r => Bad(_spots[3]).Target())),
                new Decorator(r => (Me.CurrentTarget == null || (Me.CurrentTarget != null && Me.CurrentTarget.IsFriendly)) && (Geomancer(_spots[3]).CurrentTarget != null),
                    new Action(r => Geomancer(_spots[3]).CurrentTarget.Target())),
                new Decorator(r => !Me.Combat && Bad(_spots[3]) != null, DoPull),
                new Decorator(r => Me.Combat && Bad(_spots[3]) != null && !Me.CurrentTarget.IsFriendly, DoDps),
                    new Decorator(r => Bad(_spots[3]) == null,
