...
namespace Honorbuddy.Quest_Behaviors.SpecificQuests.UndyingTwilight
{
    ...
    public class UndyingTwilight : CustomForcedBehavior
    {
        ...
        public Composite StayClose
        {
            get
            {
                return new Sequence(new ActionDebugString("Too far, moving back to location"), new Decorator(r => Me.Location.Distance(_spot) > 5, new Action(r => WoWMovement.ClickToMove(_spot))));
            }
        }
