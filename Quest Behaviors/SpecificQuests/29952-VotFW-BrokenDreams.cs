    ...
    public class BrokenDreams : CustomForcedBehavior
    {
        ...
        public Composite StepOne
        {
            get
            {
                return new Decorator(r => _stage == 0, new PrioritySelector(
                    ...
                    new Decorator(r => Alemental == null, new Action(r => Navigator.MoveTo(_point1))),
        ...
        public Composite StepTwo
        {
            get
            {
                return new Decorator(r => _stage == 1, new PrioritySelector(
                    ...
                    new Decorator(r => StupidMonkey == null, new Action(r => Navigator.MoveTo(_point2))),
            ...
            get
            {
                return
                    new PrioritySelector(
                        new Decorator(r => _point3.Distance(Me.Location) > 10 && _bouncestage <= 0, new Action(r => Navigator.MoveTo(_point3))),
                        new Decorator(r => _point3.Distance(Me.Location) < 10 && _bouncestage == 0, new Action(r => _stage = 1))
                        );
            }
        }
        ...
        public Composite bouncez
        {
            get
            {
                return
                    new PrioritySelector(
                        new Decorator(r => _bounce.Distance(Me.Location) > 3 && _bouncestage == 1, new Action(r => Navigator.MoveTo(_bounce))),
                        new Decorator(r => _bounce.Distance(Me.Location) <= 3 && _bouncestage == 1, new Action(r => _stage = -1))
                        );
            }
        }
        ...
        public Composite StepThree
        {
            get
            {
                return new Decorator(r => _stage == 2, new PrioritySelector(bouncez, Move));
            }
        }
