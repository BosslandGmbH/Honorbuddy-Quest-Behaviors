...
namespace Honorbuddy.Quest_Behaviors.SpecificQuests.TheMarinersRevenge
{
    ...
    public class squid : CustomForcedBehavior
    {
        ...
        private WoWUnit enemy(int stage)
        {
            return ObjectManager.GetObjectsOfType<WoWUnit>().FirstOrDefault(r => r.Entry == _parts[stage]);
        }

        private uint[] _parts = new uint[] { 0, 64222, 64228, 64229, 64230 };
