...
namespace Honorbuddy.Quest_Behaviors.SpecificQuests.Nightmare
{
    ...
    public class Nightmare : CustomForcedBehavior
    {
        ...
        public Composite MoveBack
        {
            get
            {
                return new Decorator(r => Me.Location.Distance(_spot) > 5, new Action(r => Navigator.MoveTo(_spot)));
            }
        }
        ...
        public Composite EmptyMeter
        {
            get
            {
                return new Decorator(r => Me.Location.Distance(_spot) <= 5 && power > 0, new ActionAlwaysSucceed());
            }
        }
