...
namespace Honorbuddy.Quest_Behaviors.SpecificQuests.HordeBorntoShred
{
    ...
    public class BorntoShred : CustomForcedBehavior
    {
        ...
        private Vector3 _startPoint = new Vector3(2793.999f, 2530.484f, 121.1405f);
        ...
        public BorntoShred(Dictionary<string, string> args) : base(args)
        {
            ...
            try
            {
                QuestId = 33729; //GetAttributeAsQuestId("QuestId", true, null) ?? 0;
            }
            ...
            return new Decorator(r => !Query.IsInVehicle() && !Me.IsActuallyInCombat,
                new PrioritySelector(
                    new Decorator(r => IronShredder != null,
                        new Sequence(
                            new Action(r => IronShredder.Interact()),
                            new Sleep(2000))),
