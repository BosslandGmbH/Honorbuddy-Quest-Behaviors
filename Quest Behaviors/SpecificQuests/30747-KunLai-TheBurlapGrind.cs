...
namespace Honorbuddy.Quest_Behaviors.SpecificQuests.TheBurlapGrind
{
    ...
    public class TheBurlapGrind : CustomForcedBehavior
    {
        ...
        private Vector3 _startPoint = new Vector3(2726.94f, 2179.04f, 590.6934f);
        private Vector3 _waitPoint = new Vector3(2793.078f, 1773.688f, 638.9326f);
        private bool _isBehaviorDone;


        private Composite _root;
        private bool _useMount;
        private Vector3 _point1 = new Vector3(2794.707f, 1695.803f, 642.4144f);
        ...
        public WoWUnit Yeti
        {
            get
            {
                return ObjectManager.GetObjectsOfType<WoWUnit>()
                    .FirstOrDefault(r => r.NpcFlags == 1 && r.Entry == 60587 && r.Location.DistanceSquared(_startPoint) < 30 * 30);
            }
        }
        ...
        public Composite CreateBehavior_GetIn()
        {
            return new Decorator(r => !Query.IsInVehicle() && !Me.IsActuallyInCombat,
                new PrioritySelector(
                    ...
                    new Decorator(r => Yeti == null, new Action(r => Navigator.MoveTo(_startPoint)))));
        }
