...
namespace Honorbuddy.Quest_Behaviors.SpecificQuests.TheBurlapGrind
{
    ...
    public class TheBurlapGrind : CustomForcedBehavior
    {
        ...
        private WoWPoint _startPoint = new WoWPoint(2726.94, 2179.04, 590.6934);
        private WoWPoint _waitPoint = new WoWPoint(2793.078, 1773.688, 638.9326);
        private bool _isBehaviorDone;


        private Composite _root;
        private bool _useMount;
        private WoWPoint _point1 = new WoWPoint(2794.707, 1695.803, 642.4144);
        ...
        public WoWUnit Yeti
        {
            get
            {
                return ObjectManager.GetObjectsOfType<WoWUnit>()
                    .FirstOrDefault(r => r.NpcFlags == 1 && r.Entry == 60587 && r.Location.DistanceSqr(_startPoint) < 30 * 30);
            }
        }
