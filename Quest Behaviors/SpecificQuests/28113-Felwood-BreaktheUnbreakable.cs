    ...
    public class _28113 : CustomForcedBehavior
    {
        ...
        protected Composite CreateBehavior_QuestbotMain()
        {
            return _root ?? (_root = new Decorator(ret => !_isBehaviorDone, new PrioritySelector(DoneYet,
                ...
                new Decorator(r => !_touched && _touchdown.Distance(StyxWoW.Me.Location) < 5, new Action(r => _touched = true)),
                new Decorator(r => !_touched, new Action(r => WoWMovement.ClickToMove(_touchdown)))
                )));
        }
        ...
        public Composite DoneYet
        {
            ...
            {
                return
                    new Decorator(ret => _touched, new Action(delegate
                    {
